...
run: 
	docker run -e DISPLAY=${DISPLAY} -v /tmp/.X11-unix:/tmp/.X11-unix --net=host -v ${HOME}/.Xauthority:/home/jovyan/.Xauthority:rw -v $(PWD):/home/jovyan -it --entrypoint='' --user $(DUSER)  $(IMAGE_LATEST) bash 
