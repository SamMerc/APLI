...
void c_tbnew(const double *ear, int ne, const double *param, int ifl, double *photar,
		            double *photer, const char *init)
{
	tbnew(ear, ne, param, ifl, photar, photer, init);
	return;
}
...
void c_tbvabsfeo(const double *ear, int ne, const double *param, int ifl, double *photar,
	    double *photer, const char *init) {
	tbvabsfeo(ear, ne, param, ifl, photar, photer, init);
        return;
}
...
void c_tbgas(const double *ear, int ne, const double *param, int ifl, double *photar,
	   double *photer, const char *init) {
	tbgas(ear, ne, param, ifl, photar, photer, init);
	return;
}
...
void c_tbvabspcf(const double *ear, int ne, const double *param, int ifl, double *photar,
	    double *photer, const char *init) {
	tbvabspcf(ear, ne, param, ifl, photar, photer, init);
        return;
}
...
void c_tbvabsrel(const double *ear, int ne, const double *param, int ifl, double *photar,
	    double *photer, const char *init) {
	tbvabsrel(ear, ne, param, ifl, photar, photer, init);
	return;
}
